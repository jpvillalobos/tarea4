...
```{r}
#agregar y almacenar las tablas #1 y #2 de la NBA
nba_Table<- rbind(nba_pageTables[[1]], nba_pageTables[[2]])
...
head(wiki_Table)
```
> Segun la vista  anterior se observa que de la tabla NBA_table debe eliminarse la primera fila (pues contiene el encabezado). El mismo problema se presenta en la columna 66. También se nota que las columnas "lg" y "voting" no seran de utilizadas para hacer el clustering de la información. Serán removidas en la seguiente face.
